 ...
 * Description: Custom about page template for KnockOut with premium styling
 * 
 * @package KnockOut_Premium
 */
    ...
    <section class="values-section">
        <div class="container">
            <div class="section-header">
                <span class="section-subtitle gradient-text">WHAT WE STAND FOR</span>
                ...
                <div class="leader-content animate-slide-right">
                    ...
                    <div class="leader-achievements">
                        <div class="achievement">
                            <span class="achievement-number gradient-text">10+</span>
                            <span class="achievement-label">Years Experience</span>
                        </div>
                        <div class="achievement">
                            <span class="achievement-number gradient-text">🏆</span>
                            <span class="achievement-label">Innovation Leader</span>
                        </div>
                        <div class="achievement">
                            <span class="achievement-number gradient-text">🤝</span>
                            <span class="achievement-label">Community Builder</span>
                        </div>
                    </div>

                    <div class="leader-quote">
                        <i class="quote-icon">"</i>
                        <p>We're not just creating a venue; we're building a destination where memories are made and
                            celebrations never end.</p>
                    </div>
                </div>
            </div>
        </div>
